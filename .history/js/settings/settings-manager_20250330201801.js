...
class SettingsManager {
    ...
    _bindEvents() {
        ...
        const passwordToggleBtns = this.dialog.querySelectorAll('.password-toggle-btn');
                    ...
                    if (inputField.type === 'text') {
                        btn.innerHTML = `
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18">
                                <path d="M12 4C7 4 2.73 7.11 1 12c1.73 4.89 6 8 11 8s9.27-3.11 11-8c-1.73-4.89-6-8-11-8zm0 14c-3.79 0-7.17-2.13-9-5.5 1.83-3.37 5.21-5.5 9-5.5s7.17 2.13 9 5.5c-1.83 3.37-5.21 5.5-9 5.5zm0-10a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9z" fill="currentColor"/>
