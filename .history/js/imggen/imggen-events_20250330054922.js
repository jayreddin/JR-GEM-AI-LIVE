...
export class ImageGenEvents {
    ...
    setupImgGenEventHandlers() {
        ...
        // Use 'let' or 'const' only once at the top level of the function scope if needed,
        // or rely on references obtained earlier if passed to constructor/methods.
        // For simplicity here, we get them all within this setup function.
        const newImageBtn = document.getElementById('newImageBtn');
        ...
        */
        ...
        // The button (#imgUploadBtn) now opens the popup (#imgUploadPopup).
        // We need logic *inside* the popup to trigger the hidden input (#imageUploadInput).
        // This logic will be added when we define the popup's content.

        // Keep the 'change' listener on the hidden input itself.
        if (imageUploadInput && imageDisplay && imgUploadBtn) { // Added imgUploadBtn check
