...
try {
    ...
    window.chatManager = chatManager; // Keep global for now as events.js needs it
...
if (geminiAgent && chatManager) {
    ...
    geminiAgent.on('text', (text) => {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // const imgGenControlBar = document.getElementById('imgGenControlBar'); // <-- Removed from here
